		...
		<div id="content" class="mx-auto">
	        ...
	        <form class="form-row" method="POST" action="" style="margin-bottom: 85px;">
		          ...
		          <div class="col-sm-12">
		            ...
		            <input type="text" class="form-control" id="nome" name="nome" placeholder="Insira o novo nome da disciplina (Irá Substituir o atual nome!)">
		          </div>

		          <div class="col-sm-12">
		            <label for="num">ID da disciplina</label>
		            <input type="number" class="form-control" id="num" name="num" placeholder="Insira o ID da disciplina que você deseja alterar">
		          </div>

		          <div class="col-sm-12">
		            <label for="idPreReque">Pré requisito</label>
		            <input type="number" class="form-control  " id="idPreReque" name="idPreReque" placeholder="Insira o ID do pre requisito">
		          </div>

		          <div class="col-sm-12">
		            <label for="periodo">Período</label>
		            <input type="number" class="form-control periodo" id="periodo" name="periodo" placeholder="Insira o período">
		          </div>
